...
This file is an **index**, not a store. One line per memory, pointing at the topic file
that holds the detail. It is loaded on every run — content that grows lives in the topic
file, never here.
